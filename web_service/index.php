            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-header" style="height: 100%">
                            <img src="<?php echo $row['foto']; ?>" class="card-img-top img-circle" alt="..." style="height: 100%" >
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label"><b>Nama :</b></label><br>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr>
                        <label><b>Alamat Asal :</b></label><br>
                        <p><?php  echo $row['alamat_asal'] ?></p>
                        <hr>
                        <label><b>Alamat Malang :</b></label><br>
                        <p><?php  echo $row['alamat_mlg'] ?></p>
                        <hr>                        
                    </div>
                </div>
              </div>
